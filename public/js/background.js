document.addEventListener('DOMContentLoaded', function() {
    const numberOfStars = 500; // Reducido el número de estrellas

    // Función para crear y animar estrellas
    function createStars() {
        ...
        for (let i = 0; i < numberOfStars; i++) {
            ...
            star.style.animationDuration = `${Math.random() * 30 + 30}s`; // Reducido el rango de duración

            starField.appendChild(star);
        }
    }

    createStars(); // Llama a la función para crear estrellas al cargar la página
